export const Schema = z.object({
  ...
  学业: z.object({
    宏观经济学上: z.coerce.number().transform(v => _.clamp(v, 0, 100)),
    微观经济学上: z.coerce.number().transform(v => _.clamp(v, 0, 100)),
    金融管理上: z.coerce.number().transform(v => _.clamp(v, 0, 100)),
    宏观经济学下: z.coerce.number().transform(v => _.clamp(v, 0, 100)),
    微观经济学下: z.coerce.number().transform(v => _.clamp(v, 0, 100)),
    金融管理下: z.coerce.number().transform(v => _.clamp(v, 0, 100)),
    志愿者时长: z.coerce.number(),
    实习时长: z.coerce.number(),
    论文进度: z.coerce.number().transform(v => _.clamp(v, 0, 100)),
  }),
