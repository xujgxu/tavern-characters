...
.cloth-panel { flex: 1; padding: 12px 14px; display: flex; flex-direction: column; &:first-child { border-right: 1px solid var(--c-border); } }
.cloth-list { flex: 1; min-height: 0; display: flex; flex-direction: column; gap: 10px; }
