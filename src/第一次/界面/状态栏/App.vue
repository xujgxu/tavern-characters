...
.cloth-panel { flex: 1; padding: 10px 12px; display: flex; flex-direction: column; height: 560px; &:first-child { border-right: 1px solid var(--c-border); } }
.cloth-list { flex: 1; min-height: 0; display: flex; flex-direction: column; gap: 8px; overflow-y: auto; }
.cloth-list::-webkit-scrollbar { width: 0; height: 0; }
