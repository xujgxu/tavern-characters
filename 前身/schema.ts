...
export const Schema = z.object({
  ...
  衣柜: z.object({
    当前环境: z.string(),
    可选服装: z.record(z.string(), z.record(z.string(), z.string())),
    等待换装: z.boolean(),
    出门目的地: z.string(),
    已提示地点: z.string(),
  ...
  NPC: z.record(z.string(), z.record(z.string(), z.unknown())),

  结算: z.object({
    上轮耗时分钟: z.coerce.number().transform(v => _.max([v, 0])),
    本轮操作日志: z.array(z.string()),
    变量更新提示: z.string(),
  }),
});
